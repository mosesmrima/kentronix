...
export default function AboutUs() {
    return (
        <div className={"w-11/12 sm:h-80 h-[70vh] sm:mx-0 ml-4 justify-center flex sm:flex-row flex-col sm:flex-shrink-0 sm:relative absolute items-center"}>
            <div className={"sm:mx-0 mx-auto rounded-full  text-black z-100 sm:opacity-100 opacity-100 sm:w-6/12 w-12/12 sm:h-80 h-[55vh] px-4  flex flex-col justify-center items-center text-center"}>
                <h1>About Us</h1>
                <p>
