...
export const NavBar = () => {
    ...
    return (
        <div className={"z-10 w-full sm:h-[18dvh] h-[15dvh] shadow-2xl rounded-b-xl z-10 flex justify-between items-center sm:fixed fixed top-0 bg-gradient-to-br from-sky-400 to-sky-200"}>
